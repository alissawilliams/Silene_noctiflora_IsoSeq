...
In this folder you'll find files related to the PacBio Iso-Seq transcriptome of Silene noctiflora population OPL. The items are:
1. This README file.
...
6. Silene_clpR2s_untrimmed_final.aligned.trimmed.fas. These sequences were used to create a phylogenetic tree for CLPR2 in Silene. 

NOTE: The fasta file contains ALL of the final transcript sequences, as does the annotation report (the family finding algorithm used all transcripts in its input, but many were not included in the final output). Some of these transcripts were excluded from NCBI TSA as follows:
